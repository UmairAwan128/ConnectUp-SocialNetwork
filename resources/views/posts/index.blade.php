...
@if(count($posts) > 0)
  @foreach($posts as $post)
    ...
    <div class='row hideThisPost'>
        ...
        @if($sameUser)
           {{-- then the links of the UserName and pic will be # else link so that on pages like
            profile page these should not be link as they will open the profile page again
            which is unnessary and causes performance issue --}}
            <div class='media m-0'>
